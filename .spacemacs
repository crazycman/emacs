...
layers configuration. You are free to put any user code."
  ;; (push '(custom1
  ;;         :name "Leo"
  ;;         :url "https://dict.leo.org/ende/index_de.html")
  ;;       search-engine-alist)
...
(custom-set-variables
 ...
 '(TeX-engine-alist nil)
 '(bibtex-completion-bibliography
   (quote
    ("/home/conrad/workspace/gpl-content/scalacus/doc/lib.bib")) t)
 ...
 '(org-agenda-files
   (quote
    ("~/projects/workspace/rxjava2-jdbc/doc/tasks.org" "~/org/current.org" "~/org/notes.org")))
 ...
 '(org-capture-templates
   (quote
    (("a" "Manage" entry
      (file+headline "~/org/notes.org" "Manage")
      "* %? :MANAGE:" :clock-in t :clock-resume t)
     ("h" "Ticket" entry
      (file+headline "~/org/notes.org" "Hotline")
      "* Ticket %?" :clock-in t :clock-resume t)
     ("t" "Task" entry
      (file+headline "~/org/notes.org" "Tasks")
      "* TODO %?" :clock-in t :clock-resume t)
     ("m" "Meeting" entry
      (file+headline "~/org/notes.org" "Meeting")
